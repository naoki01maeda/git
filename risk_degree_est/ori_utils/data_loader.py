...
class DenseCapDataset(Dataset):
    ...
    def __init__(self, img_dir_root, vg_data_path, look_up_tables_path, dataset_type=None, transform=None):#train_set = DenseCapDataset(IMG_DIR_ROOT, VG_DATA_PATH, LOOK_UP_TABLES_PATH, dataset_type='train')
        #IMG_DIR_ROOT = './data/visual-genome' VG_DATA_PATH = './data/VG-regions-lite.h5' LOOK_UP_TABLES_PATH = './data/VG-regions-dicts-lite.pkl'
        ...
        self.dataset_type = dataset_type  # if dataset_type is None, all data will be use 'train' or 'val'
    ...
    def __getitem__(self, idx):
        ...
        with h5py.File(self.vg_data_path, 'r') as vg_data:
            ...
            #print(self.look_up_tables['idx_to_directory'][vg_idx])
